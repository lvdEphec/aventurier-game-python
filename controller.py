...
from settings import START_HP, START_FORCE, START_AGILITY, ENABLE_HIGHSCORE, PlayerAction
...
def main(view_class: Type[ConsoleView] = ConsoleView) -> None:
    ...
    hero = Hero(hp=START_HP, base_force=START_FORCE, agility=START_AGILITY)  # Initialisation du héros avec magie
    board = Board()
